...
namespace Tests
{
    public class TestUtils
    {
        public static Mock<IRailCommandConstruction> CommandConstructionMock()
        {
            ...
            mock.Setup(f => f.CreateCommand()).Returns(new TestUtils.Command());
        ...
        {
            protected override int FlagBits => throw new System.NotImplementedException();
        ...
        public class RailPacketComparer : IEqualityComparer<RailPacketBase>
        {
            ...
            {
                return packet.SenderTick.GetHashCode() ^ packet.LastAckTick.GetHashCode() ^ packet.LastAckEventId.GetHashCode();
            }
        }
